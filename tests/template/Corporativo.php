...
<base>
    ...
    <pessoas>
         <!-- Pessoas Válidas -->
        <pessoa nome="Pessoa 1" matricula="11111" email="p1@p1.com" cargo="1" lotacao="2" funcaoConfianca="1"/>
        <pessoa nome="Pessoa 2" matricula="22222" email="p2@p2.com" cargo="1" lotacao="2" funcaoConfianca="2"/>
        <pessoa nome="Pessoa 3" matricula="33333" email="p3@p3.com" cargo="1" lotacao="3" funcaoConfianca="2"/>
        <pessoa nome="Pessoa 4" matricula="44444" email="p4@p4.com" cargo="2" lotacao="3" funcaoConfianca=""/>
        <pessoa nome="Pessoa 5" matricula="55555" email="p5@p5.com" cargo="2" lotacao="3" funcaoConfianca=""/>
        <!-- Pessoas Inválidas -->
        <!-- Sem o nome -->
        <pessoa matricula="66666" email="p6@p6.com" cargo="1" lotacao="2" funcaoConfianca=""/>
        <!-- Nome nulo/vazio -->
        <pessoa nome="" matricula="77777" email="p7@p7.com" cargo="1" lotacao="2" funcaoConfianca=""/>
        <!-- Nome com mais de 255 caracteres -->
        <pessoa nome="" matricula="77777" email="p7@p7.com" cargo="1" lotacao="2" funcaoConfianca=""/>
        <!-- Sem cargo -->
        <pessoa nome="Pessoa 12" matricula="12121" email="p12@p12.com" lotacao="2" funcaoConfianca=""/>
        <!-- Cargo nulo -->
        <pessoa nome="Pessoa 13" matricula="13131" email="p13@p13.com" cargo="" lotacao="2" funcaoConfianca=""/>
        <!-- Cargo inexistente -->
        <pessoa nome="Pessoa 14" matricula="14141" email="p14@p14.com" cargo="1000" lotacao="2" funcaoConfianca=""/>
        <!-- Sem lotação -->
        <pessoa nome="Pessoa 15" matricula="15151" email="p15@p15.com" cargo="1" funcaoConfianca=""/>
        <!-- Lotação nula -->
        <pessoa nome="Pessoa 16" matricula="16161" email="p16@p16.com" cargo="1" lotacao="" funcaoConfianca=""/>
        <!-- Lotação inexistente -->
        <pessoa nome="Pessoa 17" matricula="17171" email="p17@p17.com" cargo="1" lotacao="1000" funcaoConfianca=""/>
        <!-- Função inexistente -->
        <pessoa nome="Pessoa 18" matricula="18181" email="p18@p18.com" cargo="1" lotacao="2" funcaoConfianca="1000"/>
        <!-- Matrícula nula/vazia -->
        <pessoa nome="Pessoa 19" matricula="" email="p19@p19.com" cargo="1" lotacao="2" funcaoConfianca=""/>
        <!-- Matrícula com mais de 20 caracteres -->
        <pessoa nome="Pessoa 20" matricula="TJKuA0ZJva5MX5FX7mnMe" email="p20@p20.com" cargo="1" lotacao="2" funcaoConfianca=""/>
        <!-- Email inválido -->
        <pessoa nome="Pessoa 21" matricula="21212" email="p21@p21" cargo="1" lotacao="2" funcaoConfianca=""/>
        <pessoa nome="Pessoa 22" matricula="22022" email="p22p21" cargo="1" lotacao="2" funcaoConfianca=""/>
    </pessoas>
</base>
XML;
