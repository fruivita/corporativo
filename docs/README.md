...
[![GitHub last commit (branch)](https://img.shields.io/github/last-commit/fruivita/corporativo/2.x?logo=github)](/../../commits/2.x)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/fruivita/corporativo/tests.yml?branch=2.x&label=tests)](/../../actions/workflows/tests.yml?query=branch%3A2.x)
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/fruivita/corporativo/static.yml?branch=2.x&label=static)](/../../actions/workflows/static.yml?query=branch%3A2.x)
