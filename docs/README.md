...
[![GitHub last commit (branch)](https://img.shields.io/github/last-commit/fruivita/corporativo/1.x?logo=github)](/../../commits/1.x)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/fruivita/corporativo/tests.yml?branch=1.x&label=tests)](/../../actions/workflows/tests.yml?query=branch%3A1.x)
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/fruivita/corporativo/static.yml?branch=1.x&label=static)](/../../actions/workflows/static.yml?query=branch%3A1.x)
