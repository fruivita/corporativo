...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/fruivita/corporativo/Testes%20unit%C3%A1rios%20e%20funcionais/2.x)](/../../actions/workflows/tests.yml?query=branch%3A2.x)
...
[![GitHub Code Style Action Status](https://img.shields.io/github/workflow/status/fruivita/corporativo/Qualidade%20de%20c%C3%B3digo/2.x)](/../../actions/workflows/static.yml?query=branch%3A2.x)
